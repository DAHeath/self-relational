...
(assert (forall ((V6 Int) (V7 Int) (i0_0 Int) (i0_1 Int) (i1_0 Int) (i1_1 Int) (n_0 Int) (n_1 Int) (s0_0 Int) (s0_1 Int) (s1_0 Int) (s1_1 Int))
   (=> (and (R1 i0_0 i1_0 n_0 s0_0 s1_0 i0_1 V7 n_1 s0_1 V6) (not (< i0_0 n_0)) (< V7 n_1) (= s1_1 (+ V6 V7)) (= i1_1 (+ V7 1))) (R1 i0_0 i1_0 n_0 s0_0 s1_0 i0_1 i1_1 n_1 s0_1 s1_1))))
...
(assert (forall ((V10 Int) (V11 Int) (V12 Int) (V13 Int) (i0_0 Int) (i0_1 Int) (i1_0 Int) (i1_1 Int) (n_0 Int) (n_1 Int) (s0_0 Int) (s0_1 Int) (s1_0 Int) (s1_1 Int))
   (=> (and (R1 V11 i1_0 n_0 V10 s1_0 i0_1 V13 n_1 s0_1 V12) (< V11 n_0) (= s0_0 (+ V10 V11)) (= i0_0 (+ V11 1)) (< V13 n_1) (= s1_1 (+ V12 V13)) (= i1_1 (+ V13 1))) (R1 i0_0 i1_0 n_0 s0_0 s1_0 i0_1 i1_1 n_1 s0_1 s1_1))))
...
(assert (forall ((V14 Int) (V15 Int) (i0_0 Int) (i0_1 Int) (i1_0 Int) (i1_1 Int) (n_0 Int) (n_1 Int) (s0_0 Int) (s0_1 Int) (s1_0 Int) (s1_1 Int))
   (=> (and (R2 i0_0 V15 n_0 s0_0 V14 i0_1 i1_1 n_1 s0_1 s1_1) (< V15 n_0) (= s1_0 (+ V14 V15)) (= i1_0 (+ V15 1))) (R2 i0_0 i1_0 n_0 s0_0 s1_0 i0_1 i1_1 n_1 s0_1 s1_1))))
